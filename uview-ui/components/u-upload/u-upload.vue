<template>
	<view class="u-upload" v-if="!disabled">
		...
		<view style="display: inline-block;margin: 0 auto;background-color: #DDDDDD;" @tap="selectFile" v-if="maxCount > lists.length">
			...
			>
			     <img src="https://office-lot.oss-cn-shenzhen.aliyuncs.com/icon/camera.png" alt="" class='img'>
